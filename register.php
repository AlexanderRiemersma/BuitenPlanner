...
if (isset($_POST['submit'])){
    ...
    $emails = $db->query('SELECT * FROM users WHERE email = ? ' , '$_POST[email]' );
    echo $emails->numRows();
...
//             $mail->SMTPDebug = SMTP::DEBUG_SERVER;                      // Enable verbose debug output
                        ...
                        $mail->send();
                        $error = "<div class='container' style='max-width: 600px;'>  <div class='alert alert-success' role='alert'>De verificatie mail is . Het kan 2 tot 5 minuten duren.</div></div>";
//
//                        //sleep
//                        sleep(5);
//                        //redirect
